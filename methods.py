...
def reset():
    ...
    if m == 1:
        ...
        g.listbox.insert("end", "=================================================")
        g.listbox.insert("end", "                                           Soha's RESTAURANT BILLING SYSTEM")
        g.listbox.insert("end", "=================================================")
...
def total():
    ...
    Latte, Espresso, Iced_latte, SexOn, Cappucino = 200, 150, 300, 230, 210
    Frappé, Doppio, Iced_cap, Mojito = 412, 380, 450, 150
    Cheese, Red, Pasta, lasagna, Carnitas = 295, 470, 900, 930, 600
    Cheeseburger, Layered, choc, Reuben = 312, 348, 612, 410
...
def recipt():
    ...
    g.listbox.delete(0, 20)
    g.listbox.insert("end", "=================================================")
    g.listbox.insert("end", ("Ref : " + str(x) + "                         Soha's RESTAURANT BILLING SYSTEM"))
    g.listbox.insert("end", "=================================================")
    g.listbox.insert("end", "                                                 ")
